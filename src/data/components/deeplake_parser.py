...
class DeepLakeDataset(Dataset):
    ...
    Parameters
    ----------
    data_dir : str or deeplake.Dataset
        The DeepLake dataset object or the path to the dataset directory.
        If `data_dir` is a string, it should be the path to the DeepLake dataset directory.
        If `data_dir` is a deeplake.Dataset object, it represents the dataset directly.
    ...
    ------
    TypeError
        If the `data_dir` parameter is neither a valid DeepLake dataset object nor a string.
