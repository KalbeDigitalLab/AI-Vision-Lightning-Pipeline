...
class BreastClassificationLightningModule(LightningModule):
    """Model training pipeline for breast cancer classification.
...
if __name__ == '__main__':
    _ = BreastClassificationLightningModule(None, None, None)
